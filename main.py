...
if __name__ == '__main__':
    ...
    if args['mode'] == 'VIDEO':
        run_video(debug=False, save_csv=True, fx=RESOLUTION[0], fy=RESOLUTION[1], lane_type='segmentation')
    elif args['mode'] == 'SOCKET':
        run_socket(debug=False, save_csv=True, fx=RESOLUTION[0], fy=RESOLUTION[1], lane_type='segmentation')
