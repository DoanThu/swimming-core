from config.general import MODE, SAVE_AFTER_SECONDS, SAVE_JSON_PATH, SAVE_CSV_PATH, VIDEO_PATH
import cv2 
...
def run_video(debug=False, save_json=False, save_csv=False, out_video='output.mp4', fx=1, fy=1):
